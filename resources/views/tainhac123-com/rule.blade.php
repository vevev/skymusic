...
<div class="main" style="padding: 10px">
    ...
    <dd>
        ...
        <p>
            - Để tải được nhạc và các ứng dụng các bạn sẽ phải trả cước phí intenet, 3G cho các nhà mạng. Chúng tôi không thu bất kỳ 1 khoản phí nào cả từ việc tải nhạc.</p>
    </dd>
    ...
    <p>
        <b>2. THU THẬP THÔNG TIN</b><br>
        Sản phẩm game và ứng dụng trên website này SẼ KHÔNG THU THẬP bất kỳ thông tin về bạn và hoàn toàn không có thành phần gián điệp bên trong.
    </p>
    <p>
