...
<html lang="vi">
<head>
<title>Nhạc Sơn Tùng MTP hay nhất, Tuyển chọn nhạc Sơn Tùng MTP từ xưa đến nay</title>
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1" />
<meta name="HandheldFriendly" content="true" />
<meta name="MobileOptimized" content="width" />
<meta name="google-site-verification" content="eh7evMwaqC5CWccjJsTwKQwgdj-ylJ30rw4Zolhm2aw" />
<meta name="msvalidate.01" content="9147E58B420E13E50D76D07F0749B320" />
<meta name="description" content="Nhạc Sơn Tùng MTP hay nhất. Tuyển chọn tất cả các bài hát của Sơn Tùng MTP đầy đủ nhất. Danh sách nhạc Sơn Tùng MTP có thể bạn chưa biết" />
...
<script>
    (adsbygoogle = window.adsbygoogle || []).push({
        google_ad_client: "ca-pub-5422849112202027",
...
<div id="html">
    <div id="header" style="padding-top: 0">
        <div class="container-default margin-block">
            ...
            <a href="{{ route('home') }}">
                            <h1 class="f18 justify red center" title="Nhạc Sơn Tùng MTP hay nhất, Tuyển chọn nhạc Sơn Tùng MTP từ xưa đến nay">Nhạc Sơn Tùng MTP hay nhất, Tuyển chọn nhạc Sơn Tùng MTP từ xưa đến nay</h1>
            </a>
            <div class="search">
                    Các bạn có thể tìm thêm <u>nhạc SƠN Tùng MTP</u> bằng cách nhập các từ khóa <strong>Sơn Tùng</strong>, <b>Sơn Tùng MTP</b>, <em>MTP</em> .. để tìm kiếm bài hát bạn muốn.
                    <form id="qr" action="{{ route('form-url-search') }}" method="get">
                            <input id="q" type="text" name="q" placeholder="Sơn Tùng , Sơn Tùng MTP, MTP .." />
                            <button type="submit" class="search_btn">Sơn Tùng MTP</button>
                    </form>
            </div>
        </div>
    </div>
    <div class="main-lists container-default">
        <div class="sontung-page">
            <div class="header-title">
                <h2>Sơn Tùng M-TP Hay nhất 2020</h2>
            </div>
            <div class="item">
                <div class="metadata">
                <b class="songname">
                ...
                <div class="group"><b class="single">Sơn Tùng MTP</b></div>
            </div>
            </div>

            <div class="header-title">
                <h2>Nhạc Sơn Tùng Hay nhất 2019</h2>
            </div>
            <div class="item">
                <div class="metadata">
                <b class="songname">
            ...
            <div class="header-title">
                <h2>Nhạc Sơn Tùng Hay nhất 2017</h2>
            </div>
            <div class="item">
                <div class="metadata">
                <b class="songname">
            ...
            <div class="header-title">
                <h2>Nhạc Sơn Tùng tuyển chọn 2016</h2>
            </div>
            <div class="item">
                <div class="metadata">
                <b class="songname">
            ...
            <div class="metadata">item">
                ...
                <div class="group"><b class="single">Sơn Tùng</b> Mdivs
                </div>pan>
            </div---->


            <div class="header-title">
                <h2>Nhạc Sơn Tùng hot nhất 2015</h2>
            </div>
            <div class="item">
                <div class="metadata">
                <b class="songname">
            ...
            <div class="header-title">
                <h2>Nhạc Sơn Tùng hay nhất năm 2014</h2>
            </div>
            ...
            <div class="header-title">
                <h2>Nhạc Sơn Tùng nghe nhiều 2014</h2>
            </div>
            ...
            <div class="item">
                ...
                <div class="group"><b class="single">M-TP,DeePink</b></div>
            </div>
            </div>
            <div class="item">
                <div class="metadata">
                ...
                <div class="group"><b class="single">Sơn Tùng M-TP , My Tin Huyền Win Yuri</b></div>
                </div>
            </div>
            <div class="item">
                <div class="metadata">
            ...
            <div class="item">
                ...
                <div class="group"><b class="single">Sơn Tùng M-TP , BabyKillah ft. Deepink</b></div>
             </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        ga('create', 'UA-81289017-3', 'auto');
        ga('send', 'pageview');

    </script>
    <script src="/bh.js" async></script>
</body>
</html>
