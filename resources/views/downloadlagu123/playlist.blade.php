...
<div class="left-bar">
    ...
    <div class="bh-audio">
        ...
        <div id="playlist-container" data-src="{{ route(
            'listen-playlist',
            [
            'slug'=>$playlist->songs[0]->slug,
            'id'=>$playlist->songs[0]->song_id,
            'playlist_id' => $playlist->playlist_id
            ]
            ) }}" data-songs="{{ $playlist->songs }}" data-playlistid="{{ $playlist->playlist_id }}"></div>
    </div>
    @endif
</div>
@endsection
